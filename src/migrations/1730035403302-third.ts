...
export class Third1730035403302 implements MigrationInterface {
    name = 'Third1730035403302'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "cancers" ("cancerId" SERIAL NOT NULL, "cancerName" character varying NOT NULL, "status" character varying, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_dfff730e20a6f0e132ff0f48e29" PRIMARY KEY ("cancerId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "patients" ADD "cancerCancerId" integer`);
